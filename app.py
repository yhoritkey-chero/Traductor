...
APP_VERSION = "v2.7 CAPTURA TRADUCIDA"
...
st.success(f"✅ {APP_VERSION} · arranque rápido activo")
st.info("🆕 ARCHIVO v2.7 CORREGIDO CARGADO CORRECTAMENTE")
st.caption(
    "Versión ligera para GitHub + Streamlit Cloud. La interfaz carga primero y las dependencias "
    "pesadas se activan solo al convertir, traducir o crear el OCR."
)
...
with st.sidebar:
    ...
    st.caption("⚡ Arranque ligero: Chromium y Tesseract se comprueban solo cuando se usan.")
